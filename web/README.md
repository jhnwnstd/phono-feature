...
| Mode-switch projection rules and per-mode helper text | `app/src/phonology_features/gui/mode_logic.py` | Desktop + web (relayed into build) |
...
| `dist/render/phonology_features/gui/{palette,constants,analysis,view_models,mode_logic,layout,vowel_layout,inventory_setup,grid_logic}.py` | Copies of the canonical desktop sources |
