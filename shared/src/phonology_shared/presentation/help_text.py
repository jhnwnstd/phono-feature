...
VOWELS_HELP_HTML: str = (
    ...
    " Open.</li>"
    "</ul>"
    "<p>If the Open row has no front vowel, a low central vowel such"
    " as /a/ can occupy the bottom-left corner instead of the bottom-center.</p>"
...
FEATURES_HELP_HTML: str = (
    ...
    " pane reports the segment's feature specification. When you set a"
    ...
    "<p><b>Querying by feature</b><br>Click + or − on a feature to"
    " add that specification to the query. Matching segments highlight in"
    " the Segments pane.</p>"
