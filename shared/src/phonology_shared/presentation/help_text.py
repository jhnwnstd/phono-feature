...
VOWELS_HELP_HTML: str = (
    ...
    " default.</p>"
    "<p>A lone low vowel is handled specially. If the Open row has no front"
    " vowel, a single low vowel is drawn in the bottom-left corner instead"
    " of the center of the bottom edge.</p>"
