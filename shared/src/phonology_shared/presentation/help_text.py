...
VOWELS_HELP_HTML: str = (
    ...
    " maps to Close, [+low] maps to Open, and [-high, -low] maps to mid"
    " region. If the inventory uses tense or ATR contrasts, those features"
    ...
    " keep all low vowels on Open; this chart enables the split by"
    " default.</p>"
    ...
    " backness sit side by side, the unrounded vowel on the left and the"
    " rounded vowel on the right. A vowel with no rounding feature sits on"
    " the centerline of the backness column.</p>"
    ...
    " differ in more complex ways stack in that cell.</p>"
    "<p><b>Diphthongs</b> stay out of the vowel space and appear in a list"
    " below it.</p>"
)
