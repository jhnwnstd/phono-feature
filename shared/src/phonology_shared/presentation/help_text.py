...
SEGMENTS_HELP_HTML: str = (
    ...
    " segment, such as a prenasalized stop or a contour affricate, is a"
    " member of every group that some part of it matches, and appears in"
    ...
    "<p>The display also adjusts group size to keep the layout readable. A"
